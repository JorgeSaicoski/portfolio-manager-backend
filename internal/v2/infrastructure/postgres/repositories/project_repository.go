...
func (r *projectRepository) Create(ctx context.Context, input dto.CreateProjectInput) (*dto.ProjectDTO, error) {
...
func (r *projectRepository) GetByID(ctx context.Context, id uint) (*dto.ProjectDTO, error) {
...
func (r *projectRepository) GetByIDs(ctx context.Context, ids []uint) ([]dto.ProjectDTO, error) {
	var records []entities.ProjectRecord
	if err := r.db.WithContext(ctx).Where("id IN ?", ids).Find(&records).Error; err != nil {
		return nil, fmt.Errorf("failed to get projects: %w", err)
	}

	dtos := make([]dto.ProjectDTO, len(records))
...
func (r *projectRepository) GetByCategoryID(ctx context.Context, categoryID uint) ([]dto.ProjectDTO, error) {
	var records []entities.ProjectRecord
...
func (r *projectRepository) GetByOwnerID(ctx context.Context, ownerID string, pagination dto.PaginationDTO) ([]dto.ProjectDTO, int64, error) {
	var records []entities.ProjectRecord
	var total int64
...
func (r *projectRepository) SearchBySkills(ctx context.Context, skills []string) ([]dto.ProjectDTO, error) {
	var records []entities.ProjectRecord
...
func (r *projectRepository) SearchByClient(ctx context.Context, client string) ([]dto.ProjectDTO, error) {
	var records []entities.ProjectRecord
...
func (r *projectRepository) Update(ctx context.Context, input dto.UpdateProjectInput) error {
...
func (r *projectRepository) recordToDTO(record *entities.ProjectRecord) *dto.ProjectDTO {
