...
func ValidateCategory(category *models2.Category) error {
	// Validate title
...
func ValidateSection(section *models2.Section) error {
	// Validate title
...
func ValidatePortfolio(portfolio *models2.Portfolio) error {
	// Validate title
...
func ValidateSectionContent(content *models2.SectionContent) error {
